		...
		return (
			<Example name="autocomplete" title="Autocomplete">
				...
				<ul className="list">
					...
					<li><code className="colored">submitOnSelectOption</code> — Set to <code className="colored">true</code> to submit the form when selecting an option. Is <code className="colored">false</code> by default.</li>
					<li><code className="colored">onInputValueChange</code> — A function that will be called whenever the user edits the value in the input field.</li>
					<li><code className="colored">scrollMaxItems</code> — The maximum height of the options dropdown, measured in the count of options that would fit vertically until they start being hidden under a scroll.</li>
