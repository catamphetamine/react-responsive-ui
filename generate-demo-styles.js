...
function transformStyle(filePath)
{
  let text = fs.readFileSync(path.join(filePath), 'utf8')
    ...
    .replace_all('var(--rrui-input-field-box-shadow-error-focus)', 'var(--rrui-input-field-box-shadow-focus)')
    .replace_all('var(--rrui-input-field-box-shadow-error)', 'var(--rrui-input-field-box-shadow)')
    .replace_all('var(--rrui-input-field-box-shadow-focus)', 'var(--rrui-input-field-box-shadow)')
    .replace_all('var(--rrui-input-field-box-shadow)', 'none')
    ...
    .replace_all('var(--rrui-select-arrow-border-left-width)', '0.22em')
    .replace_all('var(--rrui-select-arrow-border-right-width)', '0.22em')
    .replace_all('var(--rrui-select-arrow-border-top-width)', '0.35em')
    .replace_all('var(--rrui-select-arrow-border-bottom-width)', '0px')
    .replace_all('var(--rrui-select-arrow-width)', '0.45em')
    .replace_all('var(--rrui-select-arrow-height)', '0.35em')
    ...
    /* `<SlideOutMenu/>`. */
    .replace_all('var(--rrui-slide-out-menu-vertical-padding)', 'calc(var(--rrui-list-vertical-padding) * 2.5)')
    .replace_all('var(--rrui-slide-out-menu-box-shadow)', '0 0 0.2em rgba(0, 0, 0, 0.4)')
    .replace_all('var(--rrui-slide-out-menu-opacity)', '0.9')
    /* `<SlideOutMenu/>` :active. */
    ...
    .replace_all('var(--rrui-slide-out-menu-animation-duration)', '220ms')
